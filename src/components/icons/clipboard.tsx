  ...
  return (
    ...
    >
      <rect
        ...
        rx="3"
        className={clsx(
          'dark:group-hover:fill-[#ffd902] transition-all dark:fill-[#ffd902] fill-[#BABABB] group-hover:fill-[#e89105]',
      ...
      <path
        ...
        className={clsx(
          'dark:group-hover:fill-[#ffd902] transition-all dark:fill-[#ffd902] fill-[#5B5966] group-hover:fill-[#ffd902] ',
          { 'dark:!fill-[#e89105] fill-[#ffd902] ': selected }
        )}
      />
      <path
        fillRule="evenodd"
        ...
        className={clsx(
          'dark:group-hover:fill-[#ffd902] transition-all dark:fill-[#ffd902] fill-[#ffd902] group-hover:fill-[#ffd902] ',
          { 'dark:!fill-[#e89105] fill-[#ffd902] ': selected }
        )}
      />
      <path
        ...
        className={clsx(
          'dark:group-hover:fill-[#ffd902] transition-all dark:fill-[#353346] fill-[#ffd902] group-hover:fill-[#e89105]',
          { 'dark:!fill-[#ffd902] fill-[#e89105] ': selected }
        )}
      />
    </svg>
